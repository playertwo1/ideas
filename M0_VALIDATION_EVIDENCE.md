...
Validação local executada com implementação compatível com JSON Schema Draft 2020-12 (`jsonschema` 4.26.0) e checagem semântica determinística equivalente às regras de `VALIDATION_CONTRACT.md`.
